        ...
        <div className="space-y-4">
            ...
            <div className="flex flex-col md:flex-row gap-4 items-center justify-between glass-card p-3 bg-white/50 backdrop-blur-md">
                ...
                <button
                    onClick={() => {
                        setEditingIntern(null);
                        setFormData({ full_name: "", email: "", role: "", project: "", mentor: "", start_date: "", end_date: "", status: "Scheduled" });
                        setIsModalOpen(true);
                    }}
                                    ...
                                    <tr key={intern.id} className="group hover:bg-indigo-50/30 transition-all duration-300">
                                        <td className="p-4">
                                            <div className="flex items-center gap-4">
                                                <div className={cn("w-12 h-12 rounded-2xl flex items-center justify-center text-base font-black border shadow-sm transition-transform group-hover:scale-110", config.bg, config.text, "border-" + config.color + "-100")}>
                                                    {intern.full_name.split(" ").map(n => n[0]).slice(0, 2).join("")}
                                                </div>
                                                <div>
                                                    ...
                                                    <div className="text-[11px] font-bold text-slate-400 mt-0.5">{intern.email}</div>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="p-4">
                                            <div className="space-y-1.5">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span className="text-xs font-black text-slate-700 uppercase tracking-tight">{intern.project || "Unassigned"}</span>
                                                </div>
                                        ...
                                        <td className="p-4">
                                            <div className="space-y-2">
                                                ...
                                                <div className="w-full max-w-[120px] bg-slate-100 rounded-full h-1.5 overflow-hidden ring-1 ring-slate-100">
                                                    <div className={cn("h-full transition-all duration-1000", config.bg.replace('bg-', 'bg-').replace('-50', '-500'))} />
                                                </div>
                                            </div>
                                        </td>
                                        <td className="p-4">
