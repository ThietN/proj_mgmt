...
var require_middleware = __commonJS({
  ".next/server/middleware.js"() {
    ...
    (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[751], { 165: (a, b, c) => {
      ...
      "use strict";
      let d, e;
      c.r(b), c.d(b, { default: () => b9 });
      var f, g = {};
      async function h() {
        return "_ENTRIES" in globalThis && _ENTRIES.middleware_instrumentation && await _ENTRIES.middleware_instrumentation;
      }
      c.r(g), c.d(g, { config: () => b5, middleware: () => b4 });
      let i = null;
      async function j() {
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
        ...
        return !function(a11, b11, c3) {
          switch (b11) {
            ...
            case "HS512": {
              ...
              if (bI(a11.algorithm.hash) !== c4) throw bH(`SHA-${c4}`, "algorithm.hash");
              break;
            }
            case "RS256":
            case "RS384":
      ...
      }, bP = (a10) => a10?.[Symbol.toStringTag] === "KeyObject", bQ = (a10) => bO(a10) || bP(a10), bR = (a10) => bN(a10) && "string" == typeof a10.kty, bS = (a10) => a10?.[Symbol.toStringTag], bT = (a10, b10, c2) => {
        if (void 0 !== b10.use) {
          let a11;
          switch (c2) {
            case "sign":
      ...
      async function bW(a10, b10) {
        ...
        if (bP(a10)) {
          ...
          if ("toCryptoKey" in a10 && "function" == typeof a10.toCryptoKey) try {
            return ((a11, b11) => {
              ...
              if ("ed25519" === a11.asymmetricKeyType) {
                if ("EdDSA" !== b11 && "Ed25519" !== b11) throw TypeError("given KeyObject instance cannot be used for this algorithm");
              ...
              switch (a11.asymmetricKeyType) {
                ...
                case "ml-dsa-65":
                case "ml-dsa-87":
                  if (b11 !== a11.asymmetricKeyType.toUpperCase()) throw TypeError("given KeyObject instance cannot be used for this algorithm");
                  c3 = a11.toCryptoKey(a11.asymmetricKeyType, g2, [f2 ? "verify" : "sign"]);
              }
              ...
              if ("ec" === a11.asymmetricKeyType) {
                ...
                "ES256" === b11 && "P-256" === d3 && (c3 = a11.toCryptoKey({ name: "ECDSA", namedCurve: d3 }, g2, [f2 ? "verify" : "sign"])), "ES384" === b11 && "P-384" === d3 && (c3 = a11.toCryptoKey({ name: "ECDSA", namedCurve: d3 }, g2, [f2 ? "verify" : "sign"])), "ES512" === b11 && "P-521" === d3 && (c3 = a11.toCryptoKey({ name: "ECDSA", namedCurve: d3 }, g2, [f2 ? "verify" : "sign"])), b11.startsWith("ECDH-ES") && (c3 = a11.toCryptoKey({ name: "ECDH", namedCurve: d3 }, g2, f2 ? [] : ["deriveBits"]));
              }
          ...
          return bV(a10, c2, b10);
        }
        if (bR(a10)) return a10.k ? bx(a10.k) : bV(a10, a10, b10, true);
        throw Error("unreachable");
      }
      async function bX(a10, b10, c2) {
        let d2, e2;
        if (!bN(a10)) throw new bD("Flattened JWS must be an object");
        ...
        if (void 0 !== a10.header && !bN(a10.header)) throw new bD("JWS Unprotected Header incorrect type");
        let f2 = {};
        ...
        if (!function(...a11) {
          ...
          return true;
        }(f2, a10.header)) throw new bD("JWS Protected and JWS Unprotected Header Parameter names must be disjoint");
        let g2 = { ...f2, ...a10.header }, h2 = function(a11, b11, c3, d3, e3) {
          let f3;
        ...
        }(bD, /* @__PURE__ */ new Map([["b64", true]]), c2?.crit, f2, g2), i2 = true;
        if (h2.has("b64") && "boolean" != typeof (i2 = f2.b64)) throw new bD('The "b64" (base64url-encode payload) Header Parameter must be a boolean');
        let { alg: j2 } = g2;
        if ("string" != typeof j2 || !j2) throw new bD('JWS "alg" (Algorithm) Header Parameter missing or invalid');
        let k2 = c2 && function(a11, b11) {
        ...
        let l2 = false;
        "function" == typeof b10 && (b10 = await b10(f2, a10), l2 = true);
        var m2 = b10, n2 = "verify";
          ...
          case "PB":
            ((a11, b11, c3) => {
              if (!(b11 instanceof Uint8Array)) {
                if (bR(b11)) {
                  let d3;
                  if ("oct" === (d3 = b11).kty && "string" == typeof d3.k && bT(a11, b11, c3)) return;
                ...
                if (!bQ(b11)) throw TypeError(bK(a11, b11, "CryptoKey", "KeyObject", "JSON Web Key", "Uint8Array"));
                if ("secret" !== b11.type) throw TypeError(`${bS(b11)} instances for symmetric algorithms must be of type "secret"`);
              }
            })(j2, m2, n2);
            break;
          default:
            ((a11, b11, c3) => {
              if (bR(b11)) switch (c3) {
                ...
                case "sign":
                  let d3;
                  if ("oct" !== (d3 = b11).kty && ("AKP" === d3.kty && "string" == typeof d3.priv || "string" == typeof d3.d) && bT(a11, b11, c3)) return;
                  throw TypeError("JSON Web Key for this operation must be a private JWK");
                case "encrypt":
                case "verify":
                  let e3;
                  if ("oct" !== (e3 = b11).kty && void 0 === e3.d && void 0 === e3.priv && bT(a11, b11, c3)) return;
                  throw TypeError("JSON Web Key for this operation must be a public JWK");
              }
              if (!bQ(b11)) throw TypeError(bK(a11, b11, "CryptoKey", "KeyObject", "JSON Web Key"));
              if ("secret" === b11.type) throw TypeError(`${bS(b11)} instances for asymmetric algorithms must not be of type "secret"`);
              if ("public" === b11.type) switch (c3) {
                case "sign":
                  throw TypeError(`${bS(b11)} instances for asymmetric algorithm signing must be of type "private"`);
                case "decrypt":
                  throw TypeError(`${bS(b11)} instances for asymmetric algorithm decryption must be of type "private"`);
              }
              if ("private" === b11.type) switch (c3) {
                case "verify":
                  throw TypeError(`${bS(b11)} instances for asymmetric algorithm verifying must be of type "public"`);
                case "encrypt":
                  throw TypeError(`${bS(b11)} instances for asymmetric algorithm encryption must be of type "public"`);
              }
            })(j2, m2, n2);
        }
        let o2 = function(...a11) {
          ...
          return b11;
        }(void 0 !== a10.protected ? bw(a10.protected) : new Uint8Array(), bw("."), "string" == typeof a10.payload ? i2 ? bw(a10.payload) : bu.encode(a10.payload) : a10.payload);
        try {
          d2 = bx(a10.signature);
        } catch {
          throw new bD("Failed to base64url decode the signature");
        }
        let p2 = await bW(b10, j2);
        if (!await bM(j2, p2, d2, o2)) throw new bG();
        if (i2) try {
          e2 = bx(a10.payload);
        } catch {
          throw new bD("Failed to base64url decode the payload");
        }
        else e2 = "string" == typeof a10.payload ? bu.encode(a10.payload) : a10.payload;
        let q2 = { payload: e2 };
        return (void 0 !== a10.protected && (q2.protectedHeader = f2), void 0 !== a10.header && (q2.unprotectedHeader = a10.header), l2) ? { ...q2, key: p2 } : q2;
      }
      async function bY(a10, b10, c2) {
        ...
        let h2 = await bX({ payload: e2, protected: d2, signature: f2 }, b10, c2), i2 = { payload: h2.payload, protectedHeader: h2.protectedHeader };
        return "function" == typeof b10 ? { ...i2, key: h2.key } : i2;
      }
      let bZ = /^(\+|\-)? ?(\d+|\d+\.\d+) ?(seconds?|secs?|s|minutes?|mins?|m|hours?|hrs?|h|days?|d|weeks?|w|years?|yrs?|y)(?: (ago|from now))?$/i;
      function b$(a10) {
        let b10, c2 = bZ.exec(a10);
      ...
      let b_ = (a10) => a10.includes("/") ? a10.toLowerCase() : `application/${a10.toLowerCase()}`;
      async function b0(a10, b10, c2) {
        let d2 = await bY(a10, b10, c2);
        ...
        let e2 = { payload: function(a11, b11, c3 = {}) {
          ...
          if (!bN(f2)) throw new bE("JWT Claims Set must be a top-level JSON object");
          let { typ: h2 } = c3;
          if (h2 && ("string" != typeof a11.typ || b_(a11.typ) !== b_(h2))) throw new bz('unexpected "typ" JWT header value', f2, "typ", "check_failed");
          ...
          if (m2) {
            let a12 = p2 - f2.iat;
            if (a12 - g2 > ("number" == typeof m2 ? m2 : b$(m2))) throw new bA('"iat" claim timestamp check failed (too far in the past)', f2, "iat", "check_failed");
      ...
      let b1 = new TextEncoder().encode(process.env.JWT_SECRET || "super-secret-key-change-me");
      async function b2(a10) {
        try {
          let { payload: b10 } = await b0(a10, b1);
          return b10;
        } catch (a11) {
          return null;
        }
      }
      let b3 = ["/login", "/register", "/api/auth/login", "/api/auth/register", "/surveys/view", "/api/surveys/public", "/api/surveys/responses"];
      async function b4(a10) {
        let { pathname: b10 } = a10.nextUrl;
        if (b3.some((a11) => b10.startsWith(a11)) || b10.startsWith("/_next") || b10.startsWith("/favicon.ico")) return T.next();
        let c2 = a10.cookies.get("auth_token")?.value;
        if (!c2) return b10.startsWith("/api") ? T.json({ error: "Unauthorized" }, { status: 401 }) : T.redirect(new URL("/login", a10.url));
        let d2 = await b2(c2);
        if (!d2) return b10.startsWith("/api") ? T.json({ error: "Invalid token" }, { status: 401 }) : T.redirect(new URL("/login", a10.url));
        if ("SuperAdmin" !== d2.role) {
          let c3 = "/tracking" === b10 || b10.startsWith("/tracking/"), d3 = b10.startsWith("/api");
          if (!c3 && !d3) return T.redirect(new URL("/tracking", a10.url));
        }
        return T.next();
      }
      let b5 = { matcher: ["/((?!_next/static|_next/image|favicon.ico).*)"] };
      Object.values({ NOT_FOUND: 404, FORBIDDEN: 403, UNAUTHORIZED: 401 });
      let b6 = { ...g }, b7 = b6.middleware || b6.default, b8 = "/middleware";
      if ("function" != typeof b7) throw Object.defineProperty(Error(`The Middleware "${b8}" must export a \`middleware\` or a \`default\` function`), "__NEXT_ERROR_CODE", { value: "E120", enumerable: false, configurable: true });
      function b9(a10) {
        return bh({ ...a10, page: b8, handler: async (...a11) => {
          try {
            return await b7(...a11);
          } catch (e2) {
...
var NextConfig = { "env": {}, "webpack": null, "eslint": { "ignoreDuringBuilds": false }, "typescript": { "ignoreBuildErrors": false, "tsconfigPath": "tsconfig.json" }, "typedRoutes": false, "distDir": ".next", "cleanDistDir": true, "assetPrefix": "", "cacheMaxMemorySize": 52428800, "configOrigin": "next.config.js", "useFileSystemPublicRoutes": true, "generateEtags": true, "pageExtensions": ["tsx", "ts", "jsx", "js"], "poweredByHeader": true, "compress": true, "images": { "deviceSizes": [640, 750, 828, 1080, 1200, 1920, 2048, 3840], "imageSizes": [16, 32, 48, 64, 96, 128, 256, 384], "path": "/_next/image", "loader": "default", "loaderFile": "", "domains": [], "disableStaticImages": false, "minimumCacheTTL": 60, "formats": ["image/webp"], "maximumResponseBody": 5e7, "dangerouslyAllowSVG": false, "contentSecurityPolicy": "script-src 'none'; frame-src 'none'; sandbox;", "contentDispositionType": "attachment", "remotePatterns": [], "unoptimized": false }, "devIndicators": { "position": "bottom-left" }, "onDemandEntries": { "maxInactiveAge": 6e4, "pagesBufferLength": 5 }, "amp": { "canonicalBase": "" }, "basePath": "", "sassOptions": {}, "trailingSlash": false, "i18n": null, "productionBrowserSourceMaps": false, "excludeDefaultMomentLocales": true, "serverRuntimeConfig": {}, "publicRuntimeConfig": {}, "reactProductionProfiling": false, "reactStrictMode": null, "reactMaxHeadersLength": 6e3, "httpAgentOptions": { "keepAlive": true }, "logging": {}, "compiler": {}, "expireTime": 31536e3, "staticPageGenerationTimeout": 60, "output": "standalone", "modularizeImports": { "@mui/icons-material": { "transform": "@mui/icons-material/{{member}}" }, "lodash": { "transform": "lodash/{{member}}" } }, "outputFileTracingRoot": "D:\\Development\\ProjectMgmt", "experimental": { "useSkewCookie": false, "cacheLife": { "default": { "stale": 300, "revalidate": 900, "expire": 4294967294 }, "seconds": { "stale": 30, "revalidate": 1, "expire": 60 }, "minutes": { "stale": 300, "revalidate": 60, "expire": 3600 }, "hours": { "stale": 300, "revalidate": 3600, "expire": 86400 }, "days": { "stale": 300, "revalidate": 86400, "expire": 604800 }, "weeks": { "stale": 300, "revalidate": 604800, "expire": 2592e3 }, "max": { "stale": 300, "revalidate": 2592e3, "expire": 4294967294 } }, "cacheHandlers": {}, "cssChunking": true, "multiZoneDraftMode": false, "appNavFailHandling": false, "prerenderEarlyExit": true, "serverMinification": true, "serverSourceMaps": false, "linkNoTouchStart": false, "caseSensitiveRoutes": false, "clientSegmentCache": false, "clientParamParsing": false, "dynamicOnHover": false, "preloadEntriesOnStart": true, "clientRouterFilter": true, "clientRouterFilterRedirects": false, "fetchCacheKeyPrefix": "", "middlewarePrefetch": "flexible", "optimisticClientCache": true, "manualClientBasePath": false, "cpus": 11, "memoryBasedWorkersCount": false, "imgOptConcurrency": null, "imgOptTimeoutInSeconds": 7, "imgOptMaxInputPixels": 268402689, "imgOptSequentialRead": null, "imgOptSkipMetadata": null, "isrFlushToDisk": true, "workerThreads": false, "optimizeCss": false, "nextScriptWorkers": false, "scrollRestoration": false, "externalDir": false, "disableOptimizedLoading": false, "gzipSize": true, "craCompat": false, "esmExternals": true, "fullySpecified": false, "swcTraceProfiling": false, "forceSwcTransforms": false, "largePageDataBytes": 128e3, "typedEnv": false, "parallelServerCompiles": false, "parallelServerBuildTraces": false, "ppr": false, "authInterrupts": false, "webpackMemoryOptimizations": false, "optimizeServerReact": true, "viewTransition": false, "routerBFCache": false, "removeUncaughtErrorAndRejectionListeners": false, "validateRSCRequestHeaders": false, "staleTimes": { "dynamic": 0, "static": 300 }, "serverComponentsHmrCache": true, "staticGenerationMaxConcurrency": 8, "staticGenerationMinPagesPerWorker": 25, "cacheComponents": false, "inlineCss": false, "useCache": false, "globalNotFound": false, "devtoolSegmentExplorer": true, "browserDebugInfoInTerminal": false, "optimizeRouterScrolling": false, "middlewareClientMaxBodySize": 10485760, "optimizePackageImports": ["lucide-react", "date-fns", "lodash-es", "ramda", "antd", "react-bootstrap", "ahooks", "@ant-design/icons", "@headlessui/react", "@headlessui-float/react", "@heroicons/react/20/solid", "@heroicons/react/24/solid", "@heroicons/react/24/outline", "@visx/visx", "@tremor/react", "rxjs", "@mui/material", "@mui/icons-material", "recharts", "react-use", "effect", "@effect/schema", "@effect/platform", "@effect/platform-node", "@effect/platform-browser", "@effect/platform-bun", "@effect/sql", "@effect/sql-mssql", "@effect/sql-mysql2", "@effect/sql-pg", "@effect/sql-sqlite-node", "@effect/sql-sqlite-bun", "@effect/sql-sqlite-wasm", "@effect/sql-sqlite-react-native", "@effect/rpc", "@effect/rpc-http", "@effect/typeclass", "@effect/experimental", "@effect/opentelemetry", "@material-ui/core", "@material-ui/icons", "@tabler/icons-react", "mui-core", "react-icons/ai", "react-icons/bi", "react-icons/bs", "react-icons/cg", "react-icons/ci", "react-icons/di", "react-icons/fa", "react-icons/fa6", "react-icons/fc", "react-icons/fi", "react-icons/gi", "react-icons/go", "react-icons/gr", "react-icons/hi", "react-icons/hi2", "react-icons/im", "react-icons/io", "react-icons/io5", "react-icons/lia", "react-icons/lib", "react-icons/lu", "react-icons/md", "react-icons/pi", "react-icons/ri", "react-icons/rx", "react-icons/si", "react-icons/sl", "react-icons/tb", "react-icons/tfi", "react-icons/ti", "react-icons/vsc", "react-icons/wi"], "trustHostHeader": false, "isExperimentalCompile": false }, "htmlLimitedBots": "[\\w-]+-Google|Google-[\\w-]+|Chrome-Lighthouse|Slurp|DuckDuckBot|baiduspider|yandex|sogou|bitlybot|tumblr|vkShare|quora link preview|redditbot|ia_archiver|Bingbot|BingPreview|applebot|facebookexternalhit|facebookcatalog|Twitterbot|LinkedInBot|Slackbot|Discordbot|WhatsApp|SkypeUriPreview|Yeti|googleweblight", "bundlePagesRouterDependencies": false, "configFileName": "next.config.js", "serverExternalPackages": [], "turbopack": { "root": "D:\\Development\\ProjectMgmt" } };
var BuildId = "DwJVIve67o4LR2kVeprxt";
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }], "routes": { "static": [{ "page": "/", "regex": "^/(?:/)?$", "routeKeys": {}, "namedRegex": "^/(?:/)?$" }, { "page": "/_dummy", "regex": "^/_dummy(?:/)?$", "routeKeys": {}, "namedRegex": "^/_dummy(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/attendance", "regex": "^/attendance(?:/)?$", "routeKeys": {}, "namedRegex": "^/attendance(?:/)?$" }, { "page": "/attendance/upload", "regex": "^/attendance/upload(?:/)?$", "routeKeys": {}, "namedRegex": "^/attendance/upload(?:/)?$" }, { "page": "/audit", "regex": "^/audit(?:/)?$", "routeKeys": {}, "namedRegex": "^/audit(?:/)?$" }, { "page": "/certifications", "regex": "^/certifications(?:/)?$", "routeKeys": {}, "namedRegex": "^/certifications(?:/)?$" }, { "page": "/certifications/catalog", "regex": "^/certifications/catalog(?:/)?$", "routeKeys": {}, "namedRegex": "^/certifications/catalog(?:/)?$" }, { "page": "/certifications/my", "regex": "^/certifications/my(?:/)?$", "routeKeys": {}, "namedRegex": "^/certifications/my(?:/)?$" }, { "page": "/certifications/tracking", "regex": "^/certifications/tracking(?:/)?$", "routeKeys": {}, "namedRegex": "^/certifications/tracking(?:/)?$" }, { "page": "/csat", "regex": "^/csat(?:/)?$", "routeKeys": {}, "namedRegex": "^/csat(?:/)?$" }, { "page": "/delivery", "regex": "^/delivery(?:/)?$", "routeKeys": {}, "namedRegex": "^/delivery(?:/)?$" }, { "page": "/documents", "regex": "^/documents(?:/)?$", "routeKeys": {}, "namedRegex": "^/documents(?:/)?$" }, { "page": "/esat", "regex": "^/esat(?:/)?$", "routeKeys": {}, "namedRegex": "^/esat(?:/)?$" }, { "page": "/esat-hub", "regex": "^/esat\\-hub(?:/)?$", "routeKeys": {}, "namedRegex": "^/esat\\-hub(?:/)?$" }, { "page": "/events", "regex": "^/events(?:/)?$", "routeKeys": {}, "namedRegex": "^/events(?:/)?$" }, { "page": "/feedback", "regex": "^/feedback(?:/)?$", "routeKeys": {}, "namedRegex": "^/feedback(?:/)?$" }, { "page": "/hiring", "regex": "^/hiring(?:/)?$", "routeKeys": {}, "namedRegex": "^/hiring(?:/)?$" }, { "page": "/innovations", "regex": "^/innovations(?:/)?$", "routeKeys": {}, "namedRegex": "^/innovations(?:/)?$" }, { "page": "/login", "regex": "^/login(?:/)?$", "routeKeys": {}, "namedRegex": "^/login(?:/)?$" }, { "page": "/polls", "regex": "^/polls(?:/)?$", "routeKeys": {}, "namedRegex": "^/polls(?:/)?$" }, { "page": "/projects", "regex": "^/projects(?:/)?$", "routeKeys": {}, "namedRegex": "^/projects(?:/)?$" }, { "page": "/register", "regex": "^/register(?:/)?$", "routeKeys": {}, "namedRegex": "^/register(?:/)?$" }, { "page": "/report", "regex": "^/report(?:/)?$", "routeKeys": {}, "namedRegex": "^/report(?:/)?$" }, { "page": "/resources", "regex": "^/resources(?:/)?$", "routeKeys": {}, "namedRegex": "^/resources(?:/)?$" }, { "page": "/skills", "regex": "^/skills(?:/)?$", "routeKeys": {}, "namedRegex": "^/skills(?:/)?$" }, { "page": "/surveys", "regex": "^/surveys(?:/)?$", "routeKeys": {}, "namedRegex": "^/surveys(?:/)?$" }, { "page": "/surveys/designer", "regex": "^/surveys/designer(?:/)?$", "routeKeys": {}, "namedRegex": "^/surveys/designer(?:/)?$" }, { "page": "/tracking", "regex": "^/tracking(?:/)?$", "routeKeys": {}, "namedRegex": "^/tracking(?:/)?$" }, { "page": "/wiki", "regex": "^/wiki(?:/)?$", "routeKeys": {}, "namedRegex": "^/wiki(?:/)?$" }], "dynamic": [{ "page": "/api/documents/[id]", "regex": "^/api/documents/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/documents/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/documents/[id]/publish", "regex": "^/api/documents/([^/]+?)/publish(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/documents/(?<nxtPid>[^/]+?)/publish(?:/)?$" }, { "page": "/api/documents/[id]/versions", "regex": "^/api/documents/([^/]+?)/versions(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/documents/(?<nxtPid>[^/]+?)/versions(?:/)?$" }, { "page": "/surveys/view/[id]", "regex": "^/surveys/view/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/surveys/view/(?<nxtPid>[^/]+?)(?:/)?$" }], "data": { "static": [{ "page": "/_dummy", "dataRouteRegex": "^/_next/data/DwJVIve67o4LR2kVeprxt/_dummy\\.json$" }], "dynamic": [] } }, "locales": [] };
var ConfigHeaders = [];
var PrerenderManifest = { "version": 4, "routes": { "/login": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/login", "dataRoute": "/login.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/documents": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/documents", "dataRoute": "/documents.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/register": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/register", "dataRoute": "/register.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/attendance/upload": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/attendance/upload", "dataRoute": "/attendance/upload.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/_not-found": { "initialStatus": 404, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/_not-found", "dataRoute": "/_not-found.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/surveys/designer": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/surveys/designer", "dataRoute": "/surveys/designer.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/surveys": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/surveys", "dataRoute": "/surveys.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] } }, "dynamicRoutes": {}, "notFoundRoutes": [], "preview": { "previewModeId": "db1c2d2183c811475b7943f77bb655ff", "previewModeSigningKey": "bf564f16fada08bd48fe9cfa40eb420036111eddc9409f3925cbf859257e815e", "previewModeEncryptionKey": "7699beae3f21948fdb3115f32fef7280840ec04016b33d390c47f068e33b8915" } };
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/middleware.js"], "name": "middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next\\/static|_next\\/image|favicon.ico).*))(\\.json)?[\\/#\\?]?$", "originalSource": "/((?!_next/static|_next/image|favicon.ico).*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "DwJVIve67o4LR2kVeprxt", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "v/DqDBgH1Vm/lBRjID/hD09AQ4fPAT7hPBFqvRM90sw=", "__NEXT_PREVIEW_MODE_ID": "db1c2d2183c811475b7943f77bb655ff", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "bf564f16fada08bd48fe9cfa40eb420036111eddc9409f3925cbf859257e815e", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "7699beae3f21948fdb3115f32fef7280840ec04016b33d390c47f068e33b8915" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/api/attendance/stats/route": "/api/attendance/stats", "/api/auth/logout/route": "/api/auth/logout", "/api/attendance/upload/route": "/api/attendance/upload", "/api/auth/login/route": "/api/auth/login", "/api/auth/me/route": "/api/auth/me", "/api/auth/register/route": "/api/auth/register", "/api/certifications/route": "/api/certifications", "/api/csat/route": "/api/csat", "/api/documents/[id]/route": "/api/documents/[id]", "/api/documents/[id]/publish/route": "/api/documents/[id]/publish", "/api/documents/[id]/versions/route": "/api/documents/[id]/versions", "/api/documents/route": "/api/documents", "/api/esat/route": "/api/esat", "/api/events/route": "/api/events", "/api/feedback/route": "/api/feedback", "/api/innovations/route": "/api/innovations", "/api/interns/cron/route": "/api/interns/cron", "/api/interns/billable/route": "/api/interns/billable", "/api/hiring/route": "/api/hiring", "/api/interns/evaluation/route": "/api/interns/evaluation", "/api/interns/metrics/route": "/api/interns/metrics", "/api/interns/route": "/api/interns", "/api/locks/force-unlock/route": "/api/locks/force-unlock", "/api/locks/heartbeat/route": "/api/locks/heartbeat", "/api/locks/route": "/api/locks", "/api/member-certifications/route": "/api/member-certifications", "/api/polls/route": "/api/polls", "/api/resources/route": "/api/resources", "/api/projects/route": "/api/projects", "/api/report/route": "/api/report", "/api/skills/definitions/route": "/api/skills/definitions", "/api/skills/matrix/route": "/api/skills/matrix", "/api/skills/route": "/api/skills", "/api/surveys/public/route": "/api/surveys/public", "/api/surveys/responses/route": "/api/surveys/responses", "/api/surveys/route": "/api/surveys", "/api/tracking/notes/route": "/api/tracking/notes", "/api/tracking/route": "/api/tracking", "/api/tracking/workspaces/route": "/api/tracking/workspaces", "/_not-found/page": "/_not-found", "/api/audit/route": "/api/audit", "/api/migrate/route": "/api/migrate", "/api/testdb/route": "/api/testdb", "/api/wiki/lock/route": "/api/wiki/lock", "/api/wiki/route": "/api/wiki", "/attendance/upload/page": "/attendance/upload", "/documents/page": "/documents", "/esat-hub/page": "/esat-hub", "/feedback/page": "/feedback", "/events/page": "/events", "/polls/page": "/polls", "/login/page": "/login", "/register/page": "/register", "/surveys/view/[id]/page": "/surveys/view/[id]", "/attendance/page": "/attendance", "/audit/page": "/audit", "/delivery/page": "/delivery", "/csat/page": "/csat", "/esat/page": "/esat", "/hiring/page": "/hiring", "/report/page": "/report", "/innovations/page": "/innovations", "/projects/page": "/projects", "/surveys/page": "/surveys", "/surveys/designer/page": "/surveys/designer", "/resources/page": "/resources", "/skills/page": "/skills", "/tracking/page": "/tracking", "/wiki/page": "/wiki", "/page": "/", "/certifications/catalog/page": "/certifications/catalog", "/certifications/page": "/certifications", "/certifications/tracking/page": "/certifications/tracking", "/certifications/my/page": "/certifications/my" };
var FunctionsConfigManifest = { "version": 1, "functions": { "/api/audit": {}, "/api/wiki/lock": {}, "/api/wiki": {} } };
var PagesManifest = { "/_app": "pages/_app.js", "/_error": "pages/_error.js", "/_dummy": "pages/_dummy.js", "/_document": "pages/_document.js", "/404": "pages/404.html" };
