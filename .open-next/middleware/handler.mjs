...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      let b3 = ["/login", "/register", "/api/auth/login", "/api/auth/register"];
      async function b4(a10) {
        let { pathname: b10 } = a10.nextUrl;
        if (b3.includes(b10) || b10.startsWith("/_next") || b10.startsWith("/favicon.ico")) return T.next();
        let c2 = a10.cookies.get("auth_token")?.value;
        return c2 ? await b2(c2) ? T.next() : b10.startsWith("/api") ? T.json({ error: "Invalid token" }, { status: 401 }) : T.redirect(new URL("/login", a10.url)) : b10.startsWith("/api") ? T.json({ error: "Unauthorized" }, { status: 401 }) : T.redirect(new URL("/login", a10.url));
      }
...
var BuildId = "ouLQFs370s1vpKiYAhVcl";
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }], "routes": { "static": [{ "page": "/", "regex": "^/(?:/)?$", "routeKeys": {}, "namedRegex": "^/(?:/)?$" }, { "page": "/_dummy", "regex": "^/_dummy(?:/)?$", "routeKeys": {}, "namedRegex": "^/_dummy(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/attendance", "regex": "^/attendance(?:/)?$", "routeKeys": {}, "namedRegex": "^/attendance(?:/)?$" }, { "page": "/attendance/upload", "regex": "^/attendance/upload(?:/)?$", "routeKeys": {}, "namedRegex": "^/attendance/upload(?:/)?$" }, { "page": "/audit", "regex": "^/audit(?:/)?$", "routeKeys": {}, "namedRegex": "^/audit(?:/)?$" }, { "page": "/csat", "regex": "^/csat(?:/)?$", "routeKeys": {}, "namedRegex": "^/csat(?:/)?$" }, { "page": "/delivery", "regex": "^/delivery(?:/)?$", "routeKeys": {}, "namedRegex": "^/delivery(?:/)?$" }, { "page": "/esat", "regex": "^/esat(?:/)?$", "routeKeys": {}, "namedRegex": "^/esat(?:/)?$" }, { "page": "/esat-hub", "regex": "^/esat\\-hub(?:/)?$", "routeKeys": {}, "namedRegex": "^/esat\\-hub(?:/)?$" }, { "page": "/events", "regex": "^/events(?:/)?$", "routeKeys": {}, "namedRegex": "^/events(?:/)?$" }, { "page": "/feedback", "regex": "^/feedback(?:/)?$", "routeKeys": {}, "namedRegex": "^/feedback(?:/)?$" }, { "page": "/hiring", "regex": "^/hiring(?:/)?$", "routeKeys": {}, "namedRegex": "^/hiring(?:/)?$" }, { "page": "/innovations", "regex": "^/innovations(?:/)?$", "routeKeys": {}, "namedRegex": "^/innovations(?:/)?$" }, { "page": "/login", "regex": "^/login(?:/)?$", "routeKeys": {}, "namedRegex": "^/login(?:/)?$" }, { "page": "/polls", "regex": "^/polls(?:/)?$", "routeKeys": {}, "namedRegex": "^/polls(?:/)?$" }, { "page": "/projects", "regex": "^/projects(?:/)?$", "routeKeys": {}, "namedRegex": "^/projects(?:/)?$" }, { "page": "/register", "regex": "^/register(?:/)?$", "routeKeys": {}, "namedRegex": "^/register(?:/)?$" }, { "page": "/report", "regex": "^/report(?:/)?$", "routeKeys": {}, "namedRegex": "^/report(?:/)?$" }, { "page": "/resources", "regex": "^/resources(?:/)?$", "routeKeys": {}, "namedRegex": "^/resources(?:/)?$" }, { "page": "/skills", "regex": "^/skills(?:/)?$", "routeKeys": {}, "namedRegex": "^/skills(?:/)?$" }, { "page": "/surveys", "regex": "^/surveys(?:/)?$", "routeKeys": {}, "namedRegex": "^/surveys(?:/)?$" }, { "page": "/tracking", "regex": "^/tracking(?:/)?$", "routeKeys": {}, "namedRegex": "^/tracking(?:/)?$" }], "dynamic": [], "data": { "static": [{ "page": "/_dummy", "dataRouteRegex": "^/_next/data/ouLQFs370s1vpKiYAhVcl/_dummy\\.json$" }], "dynamic": [] } }, "locales": [] };
var ConfigHeaders = [];
var PrerenderManifest = { "version": 4, "routes": { "/login": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/login", "dataRoute": "/login.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/_not-found": { "initialStatus": 404, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/_not-found", "dataRoute": "/_not-found.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/register": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/register", "dataRoute": "/register.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/attendance/upload": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/attendance/upload", "dataRoute": "/attendance/upload.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] } }, "dynamicRoutes": {}, "notFoundRoutes": [], "preview": { "previewModeId": "7815e11fba2e54be42b333a874cbc7c9", "previewModeSigningKey": "5eb644529b2675e81f2aac3d530703e826e2f786ec015bb51968576050262244", "previewModeEncryptionKey": "efc99ac158027fc0294f18a25d08af6a9f387cac286ea97e6cb3ce058c7b4646" } };
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/middleware.js"], "name": "middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next\\/static|_next\\/image|favicon.ico).*))(\\.json)?[\\/#\\?]?$", "originalSource": "/((?!_next/static|_next/image|favicon.ico).*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "ouLQFs370s1vpKiYAhVcl", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "xFKmjOD/NDzUa/4EwG2lFOptvwc9zuK4XfuINETX62M=", "__NEXT_PREVIEW_MODE_ID": "7815e11fba2e54be42b333a874cbc7c9", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "5eb644529b2675e81f2aac3d530703e826e2f786ec015bb51968576050262244", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "efc99ac158027fc0294f18a25d08af6a9f387cac286ea97e6cb3ce058c7b4646" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/api/attendance/stats/route": "/api/attendance/stats", "/api/attendance/upload/route": "/api/attendance/upload", "/_not-found/page": "/_not-found", "/api/auth/login/route": "/api/auth/login", "/api/auth/logout/route": "/api/auth/logout", "/api/auth/me/route": "/api/auth/me", "/api/auth/register/route": "/api/auth/register", "/api/csat/route": "/api/csat", "/api/esat/route": "/api/esat", "/api/hiring/route": "/api/hiring", "/api/events/route": "/api/events", "/api/feedback/route": "/api/feedback", "/api/interns/billable/route": "/api/interns/billable", "/api/innovations/route": "/api/innovations", "/api/interns/cron/route": "/api/interns/cron", "/api/interns/evaluation/route": "/api/interns/evaluation", "/api/interns/route": "/api/interns", "/api/interns/metrics/route": "/api/interns/metrics", "/api/projects/route": "/api/projects", "/api/polls/route": "/api/polls", "/api/report/route": "/api/report", "/api/resources/route": "/api/resources", "/api/skills/definitions/route": "/api/skills/definitions", "/api/skills/route": "/api/skills", "/api/skills/matrix/route": "/api/skills/matrix", "/api/tracking/notes/route": "/api/tracking/notes", "/api/tracking/route": "/api/tracking", "/api/tracking/workspaces/route": "/api/tracking/workspaces", "/api/surveys/route": "/api/surveys", "/api/migrate/route": "/api/migrate", "/api/testdb/route": "/api/testdb", "/attendance/upload/page": "/attendance/upload", "/esat-hub/page": "/esat-hub", "/events/page": "/events", "/feedback/page": "/feedback", "/polls/page": "/polls", "/login/page": "/login", "/surveys/page": "/surveys", "/register/page": "/register", "/attendance/page": "/attendance", "/csat/page": "/csat", "/audit/page": "/audit", "/delivery/page": "/delivery", "/esat/page": "/esat", "/hiring/page": "/hiring", "/innovations/page": "/innovations", "/report/page": "/report", "/projects/page": "/projects", "/resources/page": "/resources", "/skills/page": "/skills", "/tracking/page": "/tracking", "/page": "/", "/api/audit/route": "/api/audit" };
var FunctionsConfigManifest = { "version": 1, "functions": { "/api/audit": {} } };
